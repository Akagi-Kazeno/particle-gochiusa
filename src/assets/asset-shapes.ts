...
namespace lib {
    ...
    export class sakura7 extends asset_shapes_pixi.DisplayObjectContainer {
        public graphics: PIXI.Graphics;
    ...
    export class sakura9 extends asset_shapes_pixi.DisplayObjectContainer {
        public graphics: PIXI.Graphics;
    ...
    sakura9.prototype = new asset_shapes_pixi.drawRect(-15, -15, 15, 15);

    export class sakura10 extends asset_shapes_pixi.DisplayObjectContainer {
        public graphics: PIXI.Graphics;
